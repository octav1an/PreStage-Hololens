...
public class PRPrefab6Geo : PRGeo
{
    ...
    protected override Mesh GenerateMesh()
    {
        ...
        Vector3 v0 = new Vector3(2.696897f, 0.1f, -2.696897f);
        Vector3 v1 = new Vector3(2.696897f, 0.1f, 2.696897f);
        Vector3 v2 = new Vector3(-2.696897f, 0.1f, 2.696897f);
        Vector3 v3 = new Vector3(-2.696897f, 0.1f, -2.696897f);
        Vector3 v4 = new Vector3(2.696897f, -0.1f, -2.696897f);
        Vector3 v5 = new Vector3(2.696897f, -0.1f, 2.696897f);
        Vector3 v6 = new Vector3(-2.696897f, -0.1f, 2.696897f);
        Vector3 v7 = new Vector3(-2.696897f, -0.1f, -2.696897f);
