...
namespace GILES
{
	...
	public class pb_Selection : pb_MonoBehaviourSingleton<pb_Selection>
	{
		...
		///< Delegate called when a new GameObject is active.
		/// \sa AddOnSelectionChangeListener
		public event Callback<IEnumerable<GameObject>> OnSelectionChange;

		/**
		 * Event called on objects that were previously active but now are not.
		 */
		...
		/// A list of the currently active GameObjects.
