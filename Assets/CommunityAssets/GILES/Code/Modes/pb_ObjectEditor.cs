...
#region Member
		...
		/// Cache of each active object's transform at the beginning of handle interaction.
...
#region Handles
		...
		/**
		 * Store the transform of each active gameObject in selectionTransformOrigin array.
		 */
...
#region Mouse Events
		...
		public override void OnMouseMove()
		{
			...
			if(mMouseDragging)
			{
                ...
                // Change this method in order to avoid selecting the off objects
				UpdateDragPicker();
			}
			else
		...
		public override void OnMouseUp()
		{
            if (!handle.InUse())
            {
                ...
                else if (!IsMouseInUse())
                {
                    ...
                    GameObject hit = pb_HandleUtility.ObjectRaycastCollider(ray, pb_Scene.Children());
